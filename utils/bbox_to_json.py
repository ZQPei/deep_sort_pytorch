...
A custom json logger that can help building the output
  video on frontend application.
...
class BaseJsonBboxLogger(object):
    """
...
class Label(BaseJsonBboxLogger):
    """
...
class Frame(BaseJsonBboxLogger):
    """
    This module stores the information for each frame and use them in JsonParser
    Attributes:
...
class JsonBboxLogger(BaseJsonBboxLogger):
    """
